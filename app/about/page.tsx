    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl mb-6">
            Founded in 2023, we've quickly established ourselves as a leader in web design and hosting solutions. Our commitment to innovation, quality, and customer satisfaction sets us apart in the industry.
          </p>
          <p className="text-xl">
