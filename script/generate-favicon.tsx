...
async function generateFavicon() {
  try {   
    ...
    const gradient1 = ctx.createLinearGradient(-size / 3, -size / 3, size / 3, size / 3)
    ...
    const gradient2 = ctx.createLinearGradient(-size / 3, size / 3, size / 3, -size / 3)
    ...
    ctx.fillRect(size / 2 - innerSize / 2, size / 2 - innerSize / 2, innerSize, innerSize)
    ...
    const appleGradient1 = appleCtx.createLinearGradient(-appleSize / 3, -appleSize / 3, appleSize / 3, appleSize / 3)
    ...
    appleCtx.fillRect(-appleSquareSize / 2, -appleSquareSize / 2, appleSquareSize, appleSquareSize)
    appleCtx.restore()

    appleCtx.save()
    appleCtx.translate(appleSize / 2, appleSize / 2)
    appleCtx.rotate((12 * Math.PI) / 180)
    const appleGradient2 = appleCtx.createLinearGradient(-appleSize / 3, appleSize / 3, appleSize / 3, -appleSize / 3)
    ...
    await fs.writeFile(path.join(publicDir, "apple-touch-icon.png"), appleBuffer)
    ...
    for (const icoSize of icoSizes) {
      ...
      const icoGradient1 = icoCtx.createLinearGradient(-icoSize / 3, -icoSize / 3, icoSize / 3, icoSize / 3)
      ...
      icoCtx.fillRect(-icoSquareSize / 2, -icoSquareSize / 2, icoSquareSize, icoSquareSize)
      icoCtx.restore()
     
      icoCtx.save()
      icoCtx.translate(icoSize / 2, icoSize / 2)
      icoCtx.rotate((12 * Math.PI) / 180)
      const icoGradient2 = icoCtx.createLinearGradient(-icoSize / 3, icoSize / 3, icoSize / 3, -icoSize / 3)
      ...
      icoCtx.fillRect(icoSize / 2 - icoInnerSize / 2, icoSize / 2 - icoInnerSize / 2, icoInnerSize, icoInnerSize)
      ...
      await fs.writeFile(path.join(publicDir, `favicon-${icoSize}.png`), icoBuffer)
    }
    ...
    ogCtx.save()
    const orb1 = ogCtx.createRadialGradient(ogWidth * 0.3, ogHeight * 0.5, 0, ogWidth * 0.3, ogHeight * 0.5, 400)
    ...
    ogCtx.save()
    const orb2 = ogCtx.createRadialGradient(ogWidth * 0.8, ogHeight * 0.8, 0, ogWidth * 0.8, ogHeight * 0.8, 300)
    ...
    const logoGradient1 = ogCtx.createLinearGradient(-logoSize / 2, -logoSize / 2, logoSize / 2, logoSize / 2)
    ...
    const logoGradient2 = ogCtx.createLinearGradient(-logoSize / 2, logoSize / 2, logoSize / 2, -logoSize / 2)
